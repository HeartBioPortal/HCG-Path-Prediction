...
EXTERNAL_BRG_SIF_LOCAL=/path/to/cvd-biopathnet/data/raw/brg/pathway_commons_pc2_v14/pc-hgnc.sif.gz
EXTERNAL_BRG_SIF_HPC=/path/to/hpc/cvd-biopathnet/data/raw/brg/pathway_commons_pc2_v14/pc-hgnc.sif.gz
DATASET_DIR_WITH_EXTERNAL_BRG_LOCAL=/path/to/cvd-biopathnet/data/processed/cvd_guidelines_assoc_pc14
DATASET_DIR_WITH_EXTERNAL_BRG_HPC=/path/to/hpc/cvd-biopathnet/data/processed/cvd_guidelines_assoc_pc14
ENV_MANAGER=venv
